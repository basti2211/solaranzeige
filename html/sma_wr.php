...
do {
  ...
  ****************************************************************************/
  ...
  $rc = $funktionen->modbus_register_lesen($COM1,"30775","0002","U32","03");
  ...
  if ($aktuelleDaten["Modell"]  == "Tripower") {
    // Wechselrichter
    ...
    if ($aktuelleDaten["Geraetetype"] == "9347"  or $aktuelleDaten["Geraetetype"] == "9348" or $aktuelleDaten["Geraetetype"] == "9338") {  // Tripower 8.0,10.0 und CORE1 11.3.2021
  ...
  elseif ($aktuelleDaten["Modell"] == "Island") {
  ...
  ***************************************************************************/
  ...
  $funktionen->log_schreiben("Geräteklasse: ".$aktuelleDaten["Geraeteklasse"],"*- ",8);
