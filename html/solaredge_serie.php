...
do {
  ...
  ****************************************************************************/
  ...
  if (substr( $rc, 18, 2 ) != "00") {
    ...
    /************************
    $aktuelleDaten["PV_Leistung"] = ($aktuelleDaten["AC_Verbrauch"] + $aktuelleDaten["Batterie1Leistung"] + $aktuelleDaten["AC_Einspeisung"] - $aktuelleDaten["AC_Bezug"]);
    ************************/
    ...
    if (substr( $rc, 18, 2 ) != "00") {
      ...
      /******************
      $aktuelleDaten["PV_Leistung"] = ($aktuelleDaten["AC_Verbrauch"] + $aktuelleDaten["Batterie1Leistung"] + $aktuelleDaten["Batterie2Leistung"] + $aktuelleDaten["AC_Einspeisung"] - $aktuelleDaten["AC_Bezug"]);
