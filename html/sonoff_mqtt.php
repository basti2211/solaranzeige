...
do {
      ...
      *************************************************************************/
      ...
      if (is_array( $values )) {
        if (isset($values["StatusSNS"])) {
          $funktionen->log_schreiben( "StatusSNS Topic", "   ", 9 );
  ...
  ****************************************************************************/
  ...
  switch ($aktuelleDaten["SonoffModul"]) {
    ...
    case 0:
      if ($aktuelleDaten["DeviceName"] == "shelly" or $aktuelleDaten["DeviceName"] == "Tasmota") {
      ...
      elseif ($aktuelleDaten["DeviceName"] == "Shelly 1PM") {
      ...
      elseif ($aktuelleDaten["DeviceName"] == "shelly1") {
        ...
        $funktionen->log_schreiben( "Das Relais ist ein unbekanntes Shelly Tasmota Modul.", "   ", 5 );
      }
      break;
